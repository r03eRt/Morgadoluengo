jQuery(document).ready(function(event){
  ...
  $(window).on('popstate', function() {
	...
	function loadNewContent(url, bool) {
      ...
      setTimeout(function(){
        ...
        $('.cd-loading-bar').one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', function(){
          ...
          if(url=='contact.html'){
            ...
            TweenLite.to('.fa-twitter', 0, { opacity:0});
            TweenLite.to('.fa-facebook', 0, { opacity:0});
            TweenLite.to('.fa-linkedin', 0, { opacity:0});
            ...
            TweenLite.to(boton, 1, {delay:1,left:0,ease: Power4.easeOut,force3D:true,onComplete: hola});
                ...
                //preparacion
                TweenLite.to(photo_div,0,{color:'#212121',opacity:0,zIndex:99});
                TweenLite.to(about_div,0,{opacity:1,zIndex:99});
                TweenLite.to(about_div_p,0,{opacity:1,position:'relative',left:'50vw',zIndex:99});
                TweenLite.to(about_div_h2,0,{opacity:1,position:'relative',left:'50vw',zIndex:99});
                TweenLite.to(about_div_h3,0,{opacity:1,position:'relative',left:'50vw',zIndex:99});
                TweenLite.to(list_div,0,{opacity:1,position:'relative',left:'50vw',zIndex:99});


                //muestro entrada
                TweenLite.to(about_div,1,{delay:0.4,marginLeft:'0vw',force3D:true,ease: Power4.easeInOut});
                TweenLite.to(about_div_p,1,{delay:1.2,left:'0vw',force3D:true,ease: Power4.easeInOut});
                TweenLite.to(about_div_h2,1,{delay:0.8,left:'0vw',force3D:true,ease: Power4.easeInOut});
                TweenLite.to(about_div_h3,1,{delay:1.6,left:'0vw',force3D:true,ease: Power4.easeInOut});
                TweenLite.to(list_div,1,{delay:2,left:'0vw',force3D:true,ease: Power4.easeInOut});

                //para sacar imagen
                 $(window).hover(function(){
                  console.log('salgo');
                    TweenLite.to(photo_div ,1,{delay:1,force3D:true,autoAlpha:1,ease: Power4.easeOut});
                });
                var aFx = 70,
                    trF = 4;  
      ...
      $(".fa").mouseenter(function(){
        TweenMax.fromTo(this,0.15, {x:"-=5"},{x:"+=5",repeat:3,yoyo:true,ease:Sine.easeInOut,onComplete:function(){TweenMax.to(this.target,1.5,{x:0,ease:Elastic.easeOut})}})
 ...
 function hola(){
  ...
  function completeBouncle(){
    ...
    var contact_div=$('.contact-div');
    TweenLite.to(span,1,{color:'#555255'});
    tl.to('.fa-twitter',  0.6, { autoAlpha:1});
    tl.to('.fa-facebook', 0.7, { autoAlpha:1});
    tl.to('.fa-linkedin', 0.8, { autoAlpha:1});
  ...
  TweenLite.to(span1 ,1,{delay:2.4,right:'50vw',force3D:true,autoAlpha:1,ease: Power4.easeOut});
  TweenLite.to(span2 ,1,{delay:2.4,left:'50vw',force3D:true,autoAlpha:1,ease: Power4.easeOut});
  TweenLite.to(span2 ,1,{delay:2.4,left:'50vw',force3D:true,autoAlpha:1,ease: Power4.easeOut});
  tween = TweenMax.to(interrogation, 0.5, {css:{fontSize:'4.0rem'},repeat:-1, yoyo:true,scale:3,force3D:true});
  //tween = TweenMax.to(interrogation, 0.8, {css:{fontSize:'4.0rem'},repeat:-1, yoyo:true, onRepeat:onRepeat,scale:3,force3D:true});
  //function onRepeat() {      }                
  }
